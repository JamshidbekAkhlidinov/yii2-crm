                        ...
                        <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                            <div data-simplebar style="max-height: 320px;">
                                ...
                                <div class="dropdown-item bg-transparent text-wrap">
                                    <a href="/admin" class="btn btn-soft-secondary btn-sm rounded-pill">how to setup
                                        <i class="mdi mdi-magnify ms-1"></i></a>
                                    <a href="/admin" class="btn btn-soft-secondary btn-sm rounded-pill">buttons <i
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <h6 class="dropdown-header">Welcome <?= user()->identity->userProfile->getFullName() ?>
                                !</h6>
